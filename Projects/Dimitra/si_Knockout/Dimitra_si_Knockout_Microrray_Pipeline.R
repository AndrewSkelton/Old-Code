...
#  Description : Illumina HT-12v3 Microarray of si Knockout and Interlukin time series      |
#-------------------------------------------------------------------------------------------#
...
##'-----------------------------------------------------------------------------------------#
pData(lumi.Q)$TimeSeries      <- paste(pData(lumi.Q)$Sample_ID, 
                                       pData(lumi.Q)$Treatment, sep=".")
treatments                    <- unique(pData(lumi.Q)$TimeSeries)
treatment_arrays              <- pData(lumi.Q)$TimeSeries
...
cont_mat                      <- makeContrasts(Apicidin.no_IL1-DMSO.no_IL1, 
                                               siHDAC3.no_IL1-siCon.no_IL1,
                                               siHDAC3.no_IL1-Apicidin.no_IL1,

                                               Apicidin.IL1_1h-DMSO.IL1_1h, 
                                               siHDAC3.IL1_1h-siCon.IL1_1h,
                                               siHDAC3.IL1_1h-Apicidin.IL1_1h,

                                               Apicidin.IL1_6h-DMSO.IL1_6h, 
                                               siHDAC3.IL1_6h-siCon.IL1_6h,
                                               siHDAC3.IL1_6h-Apicidin.IL1_6h,
...
##'Model Interogation - Grouped
##'-----------------------------------------------------------------------------------------#
comparisons <- c("Apicidin.no_IL1 - DMSO.no_IL1", "siHDAC3.no_IL1 - siCon.no_IL1",
                 "siHDAC3.no_IL1 - Apicidin.no_IL1", "Apicidin.IL1_1h - DMSO.IL1_1h",
                 "siHDAC3.IL1_1h - siCon.IL1_1h", "siHDAC3.IL1_1h - Apicidin.IL1_1h",
                 "Apicidin.IL1_6h - DMSO.IL1_6h", "siHDAC3.IL1_6h - siCon.IL1_6h",
                 "siHDAC3.IL1_6h - Apicidin.IL1_6h")
